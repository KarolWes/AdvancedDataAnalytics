...
```
```{r}
ggplot(mp, aes(x = Gravimetric.Energy, y = Gravimetric.Capacity)) +
  geom_point(color = 'blue', alpha = 0.6) +  # Scatter plot points
  geom_smooth(method = 'lm', col = 'red', se = FALSE) +  # Linear regression line
  labs(
    title = paste("Correlation Plot between", "Stability Charge", "and", "Discharge"),
    x = "Stability Charge",
